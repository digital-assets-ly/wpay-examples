...
import { WPayPaymentIntent, WPayPaymentIntentMetaData, WPayWebhook } from './types';
...
export class AppController {
  ...
  async createWalletPaymentIntent() {
    ...
    const wPayPaymentIntentMetaData: WPayPaymentIntentMetaData = {
